$(document).ready(function () {
    ...
    $("#idbtnsearch").click(function () {
       var data = {
            "Search": 2, "FromDate": $("#iddtfrom").val(), "ToDate": $("#iddtto").val()
        };
        ...
        sheets: [
            {
                ...
                title: "Danh sách cước gọi liên tỉnh",
                rows: rows
            }
        ]
    });

    kendo.saveAs({ dataURI: workbook.toDataURL(), fileName: "Danh sach cuoc goi lien tinh.xlsx" });
