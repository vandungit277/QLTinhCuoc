$(document).ready(function () {
    ...
    $("#idbtnsearch").click(function () {
       var data = {
            "Search": 4, "FromDate": $("#iddtfrom").val(), "ToDate": $("#iddtto").val()
        };
        ...
        sheets: [
            {
                ...
                title: "Danh sách cước gọi dịch vụ",
                rows: rows
            }
        ]
    });

    kendo.saveAs({ dataURI: workbook.toDataURL(), fileName: "Danh sach cuoc goi dich vu.xlsx" });
