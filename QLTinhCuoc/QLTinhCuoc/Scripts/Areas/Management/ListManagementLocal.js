$(document).ready(function () {
    ...
    $("#idbtnsearch").click(function () {
       var data = {
            "Search": 1, "FromDate": $("#iddtfrom").val(), "ToDate": $("#iddtto").val()
        };
        ...
        sheets: [
            {
                ...
                title: "Danh sách cước gọi nội hạt",
                rows: rows
            }
        ]
    });
    
    kendo.saveAs({ dataURI: workbook.toDataURL(), fileName: "Danh sach cuoc goi noi hat.xlsx" });
